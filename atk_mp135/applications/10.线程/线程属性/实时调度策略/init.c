...
void thread_init(void)
{
    ...
    *__pthd_1 = (__thd_t){
        .__start_routine = __thread_1,
        .__inheritsched = PTHREAD_EXPLICIT_SCHED,
        .__policy = SCHED_RR,
        .__param.sched_priority = 50,
        .__op = THREAD_OP_REALTIME
    };

    *__pthd_2 = (__thd_t){
        .__start_routine = __thread_2,
        .__inheritsched = PTHREAD_EXPLICIT_SCHED,
        .__policy = SCHED_RR,
        .__param.sched_priority = 50,
        .__op = THREAD_OP_REALTIME
    ...
    if(ret1 != 0) {
        printf("thread 1 create failed, error=%d\n", ret1);
    }
    if(ret2 != 0) {
        printf("thread 2 create failed, error=%d\n", ret2);
    }
